...
CREATE TABLE Collaborator (
	collaborator_id int NOT NULL IDENTITY(1,1),
...
CREATE TABLE Marketplace (
	marketplace_id int NOT NULL IDENTITY(1,1),
...
CREATE TABLE Card_Design (
	card_design_id int NOT NULL IDENTITY(1,1),
	image varchar(100),
	cover varchar(100),
...
CREATE TABLE Merch (
	merch_id int NOT NULL IDENTITY(1,1),
	name varchar(50) NOT NULL,
